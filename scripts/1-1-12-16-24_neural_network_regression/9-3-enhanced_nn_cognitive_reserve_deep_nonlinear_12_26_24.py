...
def main():
    ...
    for test_name, target_col in cognitive_tests.items():
        ...
        # 결과 시각화
        plot_results(y, predictions, test_name, f'9-3-deep_nonlinear_{test_name.lower()}_results_12_26_24.png')
    
    # 결과를 DataFrame으로 저장
    results_df = pd.DataFrame(results)
    results_df.to_csv('9-3-deep_nonlinear_results_12_26_24.csv', index=False)
    print("\n최종 결과가 '9-3-deep_nonlinear_results_12_26_24.csv'에 저장되었습니다.")
